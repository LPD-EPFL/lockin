...
set output "./plots/queue_cpi_all_locks.eps";
set multiplot;
...
unset key
plot \
"./data/cpi_all_locks.dat" using 1:($4) title  "TAS" ls 1 with linespoints, \
"./data/cpi_all_locks.dat" using 1:($7) title  "TTAS" ls 2 with linespoints, \
"./data/cpi_all_locks.dat" using 1:($10) title  "TICKET" ls 3 with linespoints, \
"./data/cpi_all_locks.dat" using 1:($13) title  "MCS" ls 4 with linespoints, \
"./data/cpi_all_locks.dat" using 1:($16) title  "CLH" ls 5 with linespoints, \
"./data/cpi_all_locks.dat" using 1:($19) title  "ARRAY" ls 6 with linespoints, \
"./data/cpi_all_locks.dat" using 1:($28) title  "MUTEX" ls 9 with linespoints 
...
#set title  "CPI"; 
plot \
"./data/cpi_all_locks.dat" using 1:($2) title  "TAS" ls 1 with linespoints, \
"./data/cpi_all_locks.dat" using 1:($5) title  "TTAS" ls 2 with linespoints, \
"./data/cpi_all_locks.dat" using 1:($8) title  "TICKET" ls 3 with linespoints, \
"./data/cpi_all_locks.dat" using 1:($11) title  "MCS" ls 4 with linespoints, \
"./data/cpi_all_locks.dat" using 1:($14) title  "CLH" ls 5 with linespoints, \
"./data/cpi_all_locks.dat" using 1:($17) title  "ARRAY" ls 6 with linespoints, \
"./data/cpi_all_locks.dat" using 1:($26) title  "MUTEX" ls 9 with linespoints 
